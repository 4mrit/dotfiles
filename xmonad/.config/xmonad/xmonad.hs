...
myKeys c =
  ...
  , ("M-p", addName "dmenu"                $ spawn "rofi -show drun")
  ]
  ...
  [ ("<XF86AudioPlay>", addName "mocp play"           $ spawn "playerctl play-paus")
  ...
  , ("<XF86AudioLowerVolume>", addName "Lower vol"    $ spawn "bash $HOME/.config/rescources/script/changevolume down")
  , ("M-M1-2", addName "Lower vol"    $ spawn "bash $HOME/.config/rescources/script/changevolume down")
  
  , ("<XF86AudioRaiseVolume>", addName "Raise vol"    $ spawn "bash $HOME/.config/rescources/script/changevolume up")
  , ("M-M1-3", addName "Raise vol"    $ spawn "bash $HOME/.config/rescources/script/changevolume up")

  , ("<XF86MonBrightnessUp>", addName "raise brightness"    $ spawn "bash $HOME/.config/rescources/script/changebrightness up")
  , ("M-M1-0", addName "raise brightness"    $ spawn "bash $HOME/.config/rescources/script/changebrightness up")

  , ("<XF86MonBrightnessDown>", addName "lowe brightness"   $ spawn "bash $HOME/.config/rescources/script/changebrightness down")
  , ("M-M1-9", addName "lowe brightness"   $ spawn "bash $HOME/.config/rescources/script/changebrightness down")

  , ("<Print>", addName "Take screenshot (dmscripts)" $ maimcopy)  
  , ("M-<Print>", addName "Take screenshot (dmscripts)" $ maimsave)  
  , ("M-S<Delete>", addName "turn off monitor" $ spawn "sleep 1; xset dpms force off")
  --Screen Rotation
  , ("M-M1-<Up>", addName "rotate screen up" $spawn "xrandr -o normal")
